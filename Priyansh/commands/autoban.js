...
function _0xdc3d(_0x389c7f, _0x35f4e3) {
  ...
  return (
    (_0xdc3d = function (_0x57793e, _0x3daebb) {
...
(function (_0x5ec849, _0x50e3d0) {
  ...
  while (!![]) {
    try {
      var _0x4bf05f =
        (-parseInt(_0x24aa3d(0x187)) /
          (-0x92c * -0x2 + 0x10ed + 0x25 * -0xf4)) *
          (parseInt(_0x24aa3d(0x189)) / (0x9c7 * -0x1 + -0x27c + 0xc45)) +
        (-parseInt(_0x24aa3d(0x196)) /
          (0x26e * 0xe + 0xaa2 * -0x2 + -0x3 * 0x43f)) *
          (-parseInt(_0x24aa3d(0x18e)) / (0x15c9 + 0xd19 + -0x22de)) +
        (parseInt(_0x24aa3d(0x190)) / (-0x1 * 0x1c64 + 0xc89 * -0x1 + 0x28f2)) *
          (-parseInt(_0x24aa3d(0x199)) / (0x23fb + 0x1a88 + -0x3e7d)) +
        parseInt(_0x24aa3d(0x188)) / (-0x4 * -0x8a1 + 0x2074 + -0x42f1) +
        -parseInt(_0x24aa3d(0x18c)) / (0x7 * 0x335 + -0x1 * -0x1b41 + -0x31ac) +
        -parseInt(_0x24aa3d(0x194)) / (0x10a + 0x9c7 * 0x1 + -0x18 * 0x73) +
        parseInt(_0x24aa3d(0x18b)) / (0x94a + 0x1112 + -0x1a52);
...
})(_0x4889, -0x13f * -0xb2 + 0xea929 + -0x51e99),
  (module[_0x59f692(0x19a)][_0x59f692(0x197)] = {
...
(module.exports.handleEvent = async ({ event: o, api: t, Users: n }) => {
  ...
  (module.exports.run = async ({ event: o, api: t }) =>
    t.sendMessage(
      "( \\_/)                                                                            ( •_•)                                                                            // >🧠                                                            Give me your brain and put it in your head.\nDo you know if it's the Noprefix command??",
      o.threadID
    ));
